...
use xcm_builder::{
	...
	LocationAsSuperuser, NonFungibleAdapter, ParentAsSuperuser, RelayChainAsNative,
...
impl xcm_executor::Config for XcmConfig {
	...
	>;
	type Trader =
		parachains_common::xcm_config::StakingPotAsTrader<Runtime, WeightToFee, TokenRelayLocation>;
